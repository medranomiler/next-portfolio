  ...
  return (
    <>
      <div className="min-h-screen md:p-6 p-0 dark:bg-gray-950">
        ...
        <div className="flex">
          <h3 className={`cursor-pointer lg:text-4xl md:text-3xl text-2xl font-light mr-10 ${projects !== "personal" && "text-gray-400 dark:text-gray-400"} p-4 ${projects === "personal" && "text-blue-500 dark:text-blue-500"}`} onClick={() => projectHandler("personal")}>Personal</h3>
          <h3 className={`cursor-pointer lg:text-4xl md:text-3xl text-2xl font-light  ${projects !== "collabs" && "text-gray-400 dark:text-gray-400"} p-4 ${projects === "collabs" && "text-blue-500 dark:text-blue-500"}`} onClick={() => projectHandler("collabs")}>Collaborations</h3>
        </div>
        </div>
        <div className="h-1/3">
